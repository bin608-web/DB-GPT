...
from dbgpt_app.scene.chat_db.professional_qa.config_dialogue import ChatDialogueDBQAConfig
from dbgpt_serve.datasource.manages import ConnectorManager


class ChatDialogueDbQA(BaseChat):
    """As a DBA, Chat DB Module, chat with combine DB meta schema"""

    chat_scene: str = ChatScene.ChatDialogueDbQA.value()

    @classmethod
    def param_class(cls) -> Type[ChatDialogueDBQAConfig]:
        return ChatDialogueDBQAConfig
    ...
    def __init__(self, chat_param: ChatParam, system_app: SystemApp):
        ...
        self.database = None
        self.curr_config = chat_param.real_app_config(ChatDialogueDBQAConfig)
